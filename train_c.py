...
def main(args):
    ...
    if TASK_NAME=='COVID-19':
        ...
        trainset     = torchvision.datasets.ImageFolder(root='/content/MIT-67-publicplace/train/', transform=transform_train)

        # subdirectories = trainset.classes
        # class_weights = []

        # for subdir in subdirectories:
        #     files = os.listdir(os.path.join('/content/MIT-67-publicplace/train/', subdir))
        ...
        testset      = torchvision.datasets.ImageFolder(root='/content/MIT-67-publicplace/test/' , transform=transform_test)
