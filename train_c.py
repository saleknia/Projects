...
def main(args):
    ...
    if TASK_NAME=='COVID-19':
        ...
        trainset     = torchvision.datasets.ImageFolder(root='/content/MIT-67-workingplace/train/', transform=transform_train)

        # subdirectories = trainset.classes
        # class_weights = []

        # for subdir in subdirectories:
        #     files = os.listdir(os.path.join('/content/MIT-67-workingplace/train/', subdir))
        ...
        testset      = torchvision.datasets.ImageFolder(root='/content/MIT-67-workingplace/test/' , transform=transform_test)
