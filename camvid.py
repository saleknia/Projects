...
class CamVidDataSet(data.Dataset):
    ...
    def __init__(self, root='/content/drive/MyDrive/CamVid/CamVid', list_path='/content/drive/MyDrive/CamVid/CamVid/train.txt', max_iters=None, crop_size=(360, 360),
...
class CamVidValDataSet(data.Dataset):
    ...
    def __init__(self, root='/content/drive/MyDrive/CamVid/CamVid', list_path='/content/drive/MyDrive/CamVid/CamVid/test.txt',
