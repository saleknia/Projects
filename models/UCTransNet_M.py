...
class Attention_org(nn.Module):
    ...
    def forward(self, emb1,emb2,emb3, emb_all):
        ...
        if self.M_return:
            return O1,O2,O3, weights, probs1, probs2, probs3
        else:
...
class Block_ViT(nn.Module):
    ...
    def forward(self, emb1,emb2,emb3):
        ...
        if self.M_return:
            cx1,cx2,cx3, weights, probs1, probs2, probs3 = self.channel_attn(cx1,cx2,cx3,emb_all)
        else:
        ...
        if self.M_return:
            return x1, x2, x3, weights, probs1, probs2, probs3
        else:
...
class Encoder(nn.Module):
    ...
    def forward(self, emb1,emb2,emb3):
        ...
        if self.M_return:
            return emb1,emb2,emb3, attn_weights, probs1, probs2, probs3
        else:
...
class ChannelTransformer(nn.Module):
    ...
    def forward(self,en1,en2,en3):
        ...
        if self.M_return:
            encoded1, encoded2, encoded3, attn_weights, probs1, probs2, probs3 = self.encoder(emb1,emb2,emb3)  # (B, n_patch, hidden)
        else:
        ...
        if self.M_return:
            return x1, x2, x3, probs1, probs2, probs3
        else:
            return x1, x2, x3
