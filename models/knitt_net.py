...
class knitt_net(nn.Module):
    def __init__(self, n_channels=3, n_classes=1):
        ...
        self.reduce_1_1 = _make_nConv(in_channels=96 , out_channels=96, nb_Conv=2, activation='ReLU', dilation=1, padding=1)
        self.reduce_2_1 = _make_nConv(in_channels=192, out_channels=96, nb_Conv=2, activation='ReLU', dilation=1, padding=1)
        self.reduce_3_1 = _make_nConv(in_channels=384, out_channels=96, nb_Conv=2, activation='ReLU', dilation=1, padding=1)

        self.reduce_1_2 = _make_nConv(in_channels=96 , out_channels=96, nb_Conv=2, activation='ReLU', dilation=1, padding=1)
        self.reduce_2_2 = _make_nConv(in_channels=192, out_channels=96, nb_Conv=2, activation='ReLU', dilation=1, padding=1)
        self.reduce_3_2 = _make_nConv(in_channels=384, out_channels=96, nb_Conv=2, activation='ReLU', dilation=1, padding=1)
    ...
    def forward(self, x):
        ...
        x , e = self.knitt_b(x1, x2, x3, e1, e2, e3)
