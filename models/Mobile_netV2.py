...
import torchvision
from torchvision.models import resnet18, resnet50, efficientnet_b0, EfficientNet_B0_Weights, efficientnet_b1, EfficientNet_B1_Weights, efficientnet_b2, EfficientNet_B2_Weights, EfficientNet_B3_Weights, efficientnet_b3, EfficientNet_B5_Weights, efficientnet_b5, efficientnet_b3, EfficientNet_B4_Weights, efficientnet_b4
...
class Mobile_netV2(nn.Module):
    def __init__(self, num_classes=40, pretrained=True):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(in_features=1792, out_features=40, bias=True),
        )
