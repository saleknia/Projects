...
class MVIT(nn.Module):
    ...
    def forward(self, x):
        ...
        x0 = self.ms_ca_0(x=x0, gd=gd) + self.ms_sa_0(x=x0, gd=gd, down_sample=1)
        x1 = self.ms_ca_1(x=x1, gd=gd) + self.ms_sa_1(x=x1, gd=gd, down_sample=2)
        x2 = self.ms_ca_2(x=x2, gd=gd) + self.ms_sa_2(x=x2, gd=gd, down_sample=4)
