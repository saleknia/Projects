...
class Attention_org(nn.Module):
    def __init__(self, config, vis,channel_num):
        ...
        for _ in range(config.transformer["num_heads"]):
            ...
            query2 = nn.Linear(channel_num, channel_num, bias=False)
...
class Block_ViT(nn.Module):
    def __init__(self, config, vis, channel_num):
        ...
        self.attn_norm2 = LayerNorm(channel_num,eps=1e-6)
        ...
        self.ffn_norm2 = LayerNorm(channel_num,eps=1e-6)

        self.ffn1 = Mlp(config,channel_num,channel_num*expand_ratio)
        self.ffn2 = Mlp(config,channel_num,channel_num*expand_ratio)
...
class Encoder(nn.Module):
    def __init__(self, config, vis, channel_num):
        ...
        self.encoder_norm2 = LayerNorm(channel_num,eps=1e-6)
...
class ChannelTransformer(nn.Module):
    def __init__(self, config, vis, img_size, channel_num, patchSize):
        ...
        self.reconstruct_1 = Reconstruct(channel_num, channel_num, kernel_size=1,scale_factor=(self.patchSize,self.patchSize))
        self.reconstruct_2 = Reconstruct(channel_num, channel_num, kernel_size=1,scale_factor=(self.patchSize,self.patchSize))
