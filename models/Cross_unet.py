...
class MetaFormer(nn.Module):
    ...
    def __init__(self, drop_path=0., num_skip=3, skip_dim=[96, 192, 384], act_layer=nn.GELU, norm_layer=nn.LayerNorm):
        ...
        self.fuse_conv1 = nn.Conv2d(embed_dim*3, skip_dim[0], 1, 1, 0) 
        self.fuse_conv2 = nn.Conv2d(embed_dim*3, skip_dim[1], 1, 1, 0)
        self.fuse_conv3 = nn.Conv2d(embed_dim*3, skip_dim[2], 1, 1, 0) 
