...
#         super(Mobile_netV2_loss, self).__init__()
#         model_a = enet()
#         loaded_data_a = torch.load('/content/drive/MyDrive/checkpoint_b/Mobile_NetV2_Standford40_best.pth', map_location='cuda')
#         pretrained_a = loaded_data_a['net']
#         model_a.load_state_dict(pretrained_a)
...
#         model_b = enet()
#         loaded_data_b = torch.load('/content/drive/MyDrive/checkpoint_c/Mobile_NetV2_Standford40_best.pth', map_location='cuda')
#         pretrained_b = loaded_data_b['net']
#         model_b.load_state_dict(pretrained_b)
