...
class DATUNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=1):
        ...
        self.dc1 = nn.Conv2d(48 , 48, 1)
        self.dc2 = nn.Conv2d(96 , 48, 1)
        self.dc3 = nn.Conv2d(192, 48, 1)
        self.bn_dc1 = nn.BatchNorm2d(48)
        self.bn_dc2 = nn.BatchNorm2d(48)
        self.bn_dc3 = nn.BatchNorm2d(48)
