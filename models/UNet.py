...
class UNet(nn.Module):
    def __init__(self, n_channels=3, n_classes=1):
        ...
        # )
        # self.conv_img_seq = nn.Conv2d(in_channels=256, out_channels=192, kernel_size=1, padding=0)
