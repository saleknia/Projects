...
class seg_head(nn.Module):
    def __init__(self):
        ...
        self.conv_4 =  nn.Conv2d(64, 32, kernel_size=(1,1), stride=(1,1))
        self.conv_3 =  nn.Conv2d(32 , 16, kernel_size=(1,1), stride=(1,1))
        self.conv_2 = nn.Conv2d(16, 16, kernel_size=(1,1), stride=(1,1))

        self.conv = nn.Conv2d(16, 16, kernel_size=(1,1), stride=(1,1))
        self.BN_out = nn.BatchNorm2d(16)
        self.RELU6_out = nn.ReLU6()

        self.out = nn.Conv2d(16, 2, kernel_size=(1,1), stride=(1,1))
