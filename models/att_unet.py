...
class AttentionUNet(nn.Module):
    ...
    def __init__(self, img_ch=3, output_ch=1):
        ...
        self.Conv_2 = nn.Conv2d(128, 10 , kernel_size=1, stride=1, padding=0)
        self.Scale_2 = nn.Upsample(scale_factor=2) 

        self.Conv_3 = nn.Conv2d(256, 10 , kernel_size=1, stride=1, padding=0)
        self.Scale_3 = nn.Upsample(scale_factor=4) 

        self.Conv_4 = nn.Conv2d(512, 10 , kernel_size=1, stride=1, padding=0)
